...
function generateXML (data){
    ...
    var channel = [];
    channel.push({ title: data.disable_cdata ? data.title: { _cdata: data.title }}); // THESE ARE NEW SPECS
    channel.push({ description: data.disable_cdata  ? data.description: { _cdata: data.description || data.title } }); // THESE ARE NEW SPECS
...
function RSS (options, items) {
    ...
    this.disable_cdata      = options.disable_cdata || false; // THESE ARE NEW SPECS
